...
class YoutubeSkin extends StatelessWidget {
  YoutubeSkin(this.flutterVideoPlayerController, this.state, {Key key})
      : super();
  final FlutterVideoPlayerController flutterVideoPlayerController;
  final VideoPlayerSuccess state;
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                ...
                GestureDetector(
                    onTap: () {
                      flutterVideoPlayerController.seekTo(
                          state.controllerValue.position.inSeconds.toDouble() -
                              10);
                    },
                    child: Icon(
                      Icons.fast_rewind,
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      child: Slider(
                        ...
                        min: 0.0,
                        max:
                            state.controllerValue.duration.inSeconds.toDouble(),
                        value:
                            state.controllerValue.position.inSeconds.toDouble(),
